...
export const guidesData = [
  {
    ...
    contentHtml: `
      ...
      <ol class="list-decimal pl-5 text-sm text-slate-700 space-y-2">
        ...
        <li>Masukkan starter kompos atau tanah subur setinggi 5 sampai 10 cm di atas bantal sekam.</li>
  ...
  },
  {
    ...
    contentHtml: `
      ...
      <ol class="list-decimal pl-5 text-sm text-slate-700 space-y-2">
        ...
        <li>Gunakan bor biopori manual tegak lurus dengan kedalaman sekitar 80 sampai 100 cm dengan diameter 10 cm.</li>
...
export const kategoriEdukasiList = [
  {
    id: 'organik',
    nama: 'Sampah Organik',
    ringkasan: 'Sampah sisa makanan dan bahan hayati yang dapat membusuk.',
    contoh: ['sayur', 'buah', 'daun', 'nasi'],
    langkahPraktis: ['Tiriskan airnya', 'Simpan di wadah tertutup', 'Olah jadi kompos'],
    tipsRina: 'Jangan campur plastik dengan sampah organik.'
  },
  {
    id: 'anorganik',
    nama: 'Sampah Anorganik',
    ringkasan: 'Bahan daur ulang kering seperti botol plastik, kertas, kardus, dan logam.',
    contoh: ['botol plastik', 'kardus', 'kaleng', 'kaca'],
    langkahPraktis: ['Bilas bersih', 'Keringkan', 'Pipihkan agar hemat tempat'],
    tipsRina: 'Kumpulkan dalam keadaan bersih agar diterima Bank Sampah.'
  }
]

export const artikelPanduan = guidesData.map(g => ({
  id: g.id,
  judul: g.title,
  ringkasan: g.summary,
  isi: [g.summary]
